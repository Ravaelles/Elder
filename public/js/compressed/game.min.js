...
function MapObject(mapObject) {
    ...
    this.createElement = function () {
        var rawMapObject = this.rawObject;
    ...
    this.getCanvasX = function () {
        return ((this.rawObject['TX'] + 0.5 + this.rawObject['dTX']) * getTileSize())
                - getTileSize() / 2;
        //    return ((mapObject['TX'] + 0.5 + mapObject['dTX']) * getTileSize()) - mapObject['width'] / 2;
    };

    this.getCanvasY = function () {
        return ((this.rawObject['TY'] + 0.5 + this.rawObject['dTY']) * getTileSize())
    ...
    this.isVerticalAlignofImageToTheBottom = function () {
        return this.rawObject['vertical-align'] === 'bottom';
    };
