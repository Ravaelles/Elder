...
<a class="btn btn-success pull-right button-add" 
   href="{{ route(config('laravel5-scaffold.route-base-name') . '.create', ['scaffold' => $modelName]) }}">
...
@section('content')
<div class="row scaffold-action-index">
    <div class="col-md-12">
                ...
                <tr>
                    ...
                    <td class="text-right">
                        ...
                        <a class="btn btn-xs btn-primary" 
                           href="{{ route(config('laravel5-scaffold.route-base-name') . '.show', 
                        ...
                        <a class="btn btn-xs btn-warning" 
                           href="{{ route(config('laravel5-scaffold.route-base-name') . '.edit', 
                                   ['id' => $rawObject->getId(), 'scaffolded' => $modelName]) }}">
                        ...
                        <form action="{{ route(config('laravel5-scaffold.route-base-name') . '.destroy', 
                                ['id' => $rawObject->getId(), 'scaffolded' => $modelName]) }}" 
